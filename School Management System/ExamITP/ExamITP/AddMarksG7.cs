...
namespace ExamITP
{
    public partial class AddMarksG7 : MetroFramework.Forms.MetroForm
    {
        SqlConnection con = DBAccess.GetConnection();
        examProcess ep1;

        public AddMarksG7(examProcess ep2)
        {
            InitializeComponent();
            ep1 = ep2;
        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            if (metroLabel7.Text.ToString() == "Term1")
            {
                ...
                cmd.CommandText = "update LonGTerm1 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', Science='" + metroTextBox3.Text + "', History='" + metroTextBox4.Text + "', ICT='" + metroTextBox5.Text + "', Language='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            else if (metroLabel7.Text.ToString() == "Term2")
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update LonGTerm2 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', ICT='" + metroTextBox3.Text + "', Science='" + metroTextBox4.Text + "', History='" + metroTextBox5.Text + "', Language='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            else if (metroLabel7.Text.ToString() == "Term3")
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update LonGTerm3 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', ICT='" + metroTextBox3.Text + "', Science='" + metroTextBox4.Text + "', History='" + metroTextBox5.Text + "', Language='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void AddMarksG7_FormClosing(object sender, FormClosingEventArgs e)
        {
