...
namespace ExamITP
{
    public partial class AddMarksG3 : MetroFramework.Forms.MetroForm
    {
        SqlConnection con = DBAccess.GetConnection();

        examProcess ep1;
        public AddMarksG3(examProcess ep2)
        {
            InitializeComponent();
            ep1 = ep2;
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.AddMarksG3_FormClosing);
        }
        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            if (metroLabel7.Text.ToString() == "Term1")
            {
                ...
                cmd.CommandText = "update LonGTerm1 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', Creativity='" + metroTextBox3.Text + "', Environmental='" + metroTextBox4.Text + "', Religion='" + metroTextBox5.Text + "', firstLang='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            else if (metroLabel7.Text.ToString() == "Term2")
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update LonGTerm2 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', Creativity='" + metroTextBox3.Text + "', Environmental='" + metroTextBox4.Text + "', Religion='" + metroTextBox5.Text + "', firstLang='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            else if (metroLabel7.Text.ToString() == "Term3")
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update LonGTerm3 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', Creativity='" + metroTextBox3.Text + "', Environmental='" + metroTextBox4.Text + "', Religion='" + metroTextBox5.Text + "', firstLang='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void AddMarksG3_FormClosing(object sender, FormClosingEventArgs e)
        {
