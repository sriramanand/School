...
namespace ExamITP
{
    public partial class AddMarksG6 : MetroFramework.Forms.MetroForm
    {
        SqlConnection con = DBAccess.GetConnection();
        examProcess ep1;

        public AddMarksG6(examProcess ep2)
        {
            InitializeComponent();
            ep1 = ep2;
        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            if (metroLabel7.Text.ToString() == "Term1")
            {
                ...
                cmd.CommandText = "update LonGTerm1 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', ICT='" + metroTextBox3.Text + "', Science='" + metroTextBox4.Text + "', History='" + metroTextBox5.Text + "', Language='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void AddMarksG6_FormClosing(object sender, FormClosingEventArgs e)
        {
            ep1.refreshExProcess();
        }

        private void AddMarksG6_Load(object sender, EventArgs e)
        {
