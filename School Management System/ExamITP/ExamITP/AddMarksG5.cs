...
namespace ExamITP
{
    public partial class AddMarksG5 : MetroFramework.Forms.MetroForm
    {
        SqlConnection con = DBAccess.GetConnection();

        examProcess ep1;
        public AddMarksG5(examProcess ep2)
        {
            InitializeComponent();
            ep1 = ep2;
        ...
        private void validateMarks(String textBox1, String textBox2, String textBox3, String textBox4, String textBox5, String textBox6)
        {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            try
            {
                this.validateMarks(metroTextBox1.Text.ToString(), metroTextBox2.Text.ToString(), metroTextBox3.Text.ToString(), metroTextBox4.Text.ToString(), metroTextBox5.Text.ToString(), metroTextBox6.Text.ToString());
                ...
                else
                {
                    ...
                    float final = a1 + a2 + a3 + a4 + a5 + a6;
                    float average = final / 6;
        ...
        private void metroButton2_Click(object sender, EventArgs e)
        {
            if (metroLabel7.Text.ToString() == "Term1")
            {
                ...
                cmd.CommandText = "update LonGTerm1 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', Art='" + metroTextBox3.Text + "', Science='" + metroTextBox4.Text + "', IT='" + metroTextBox5.Text + "', Language='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            else if (metroLabel7.Text.ToString() == "Term2")
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update LonGTerm2 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', Art='" + metroTextBox3.Text + "', Science='" + metroTextBox4.Text + "', IT='" + metroTextBox5.Text + "', Language='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            else if (metroLabel7.Text.ToString() == "Term3")
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update LonGTerm3 set Term='" + metroLabel7.Text + "', English='" + metroTextBox1.Text + "', Mathematics='" + metroTextBox2.Text + "', Art='" + metroTextBox3.Text + "', Science='" + metroTextBox4.Text + "', IT='" + metroTextBox5.Text + "', Language='" + metroTextBox6.Text + "',Total='" + metroLabel17.Text + "', Average='" + metroLabel18.Text + "' where AdmissionNo='" + metroLabel15.Text + "' ";
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void AddMarksG5_Load(object sender, EventArgs e)
        {

        }

        private void AddMarksG5_FormClosing(object sender, FormClosingEventArgs e)
        {
